...
## Project Structure
    ...
    ├── justscarwebapp_dev_32550  # Django project configurations
...
1. Clone this repo and `cd justscarwebapp_dev_32550`
...
2. Clone this repo and `cd justscarwebapp_dev_32550`
